...
export const DEFAULT_LEGEND: LegendEntry[] = [
  ...
  },
  {
    ...
    label: "Boxwood",
    featureType: "boxwood",
    colorHint: { hex: "#2F5D3A", description: "dense dark-green shrub dot" },
    shapeHint: "small round evergreen shrub symbol in beds",
    defaultMaterial: "Boxwood — Buxus microphylla or similar",
    renderStyle: { fill: "#3D6B4A", stroke: "#1F4330", opacity: 0.75 },
    unit: "each",
    notes: "Evergreen shrub mass or individual plant",
  },
  {
    id: "daylily",
    label: "Daylily",
    featureType: "daylily",
    colorHint: { hex: "#E879A8", description: "pink/orange flowering perennial clump" },
    shapeHint: "small flowering perennial clump in beds",
    defaultMaterial: "Daylily — Hemerocallis spp.",
    renderStyle: { fill: "#F0A8C0", stroke: "#BE185D", patternId: "mulch", opacity: 0.85 },
    unit: "each",
    notes: "Perennial flowering accent",
  },
  {
    id: "rabbitbrush",
    label: "Rabbitbrush",
    featureType: "rabbitbrush",
    colorHint: { hex: "#D4C24A", description: "yellow-flowering grey-green shrub" },
    shapeHint: "loose grey-green shrub with yellow bloom clusters",
    defaultMaterial: "Rabbitbrush — Ericameria nauseosa",
    renderStyle: { fill: "#CFC98C", stroke: "#8A8443", patternId: "mulch", opacity: 0.85 },
    unit: "each",
    notes: "Xeric native shrub, late-season yellow bloom",
  },
  {
    id: "manzanita",
    label: "Manzanita",
    featureType: "manzanita",
    colorHint: { hex: "#8C4A3A", description: "red-barked evergreen shrub" },
    shapeHint: "low evergreen shrub with red stems",
    defaultMaterial: "Manzanita — Arctostaphylos patula",
    renderStyle: { fill: "#7C9A6A", stroke: "#8C4A3A", opacity: 0.8 },
    unit: "each",
    notes: "Evergreen xeric shrub, red bark",
  },
  {
    id: "lantana",
    label: "Lantana",
    featureType: "lantana",
    colorHint: { hex: "#F59E0B", description: "orange/yellow flowering clump" },
    shapeHint: "low mounding clump with orange-yellow flower heads",
    defaultMaterial: "Lantana — Lantana camara",
    renderStyle: { fill: "#FBBF6B", stroke: "#B45309", patternId: "mulch", opacity: 0.85 },
    unit: "each",
    notes: "Warm-season flowering accent",
  },
  {
    id: "paver_path",
    label: "Paver path",
