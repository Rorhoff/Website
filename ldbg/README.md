...
| Variable | Purpose |
|----------|---------|
| `ANTHROPIC_API_KEY` | Interpret + design content — **same key as AIRevolution** in `/home/ubuntu/Website/.env` (roryportfolio’s env file; synced to `ldbg/.env.local` on deploy) |
